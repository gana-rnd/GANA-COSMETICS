 ...
 * Confirmed shots: DMP+ (labeled box), EYE BOOSTER (labeled box), PHV (vial). */
...
export const PRODUCTS: Product[] = [
  ...
  { id:"tox", cat:"Meso Solution", name:"GANA TOX", tag:"Topical Neuromodulator",
    ...
    ings:["Argireline 100ppm","PDRN","Adenosine","Glutathione"], vol:"5ml × 10ea", price:"150", img:null, badge:"FDA + CPNP" },
  ...
  { id:"pnv", cat:"Meso Solution", name:"GANA PNV", tag:"Low-Concentration PDRN",
    ...
    ings:["PDRN 0.5%","Glutathione","HA 5mg/cc"], vol:"3ml × 5ea", price:"90", img:null, badge:"PDRN" },
  { id:"eye", cat:"Meso Solution", name:"GANA EYE", tag:"Eye Bag & Dark Circle Solution",
    ...
    ings:["Carnitine 2%","Acetyl Tetrapeptide-5"], vol:"2ml × 5ea", price:"150", img:null, badge:"Eye Care" },
  { id:"cocktail", cat:"Meso Solution", name:"GANA Cocktail", tag:"Whitening Meso Cocktail",
    ...
    ings:["Glutathione","Vitamin C"], vol:"4ml × 5+5ea", price:"90", img:null, badge:"Whitening" },
  { id:"tc-plus", cat:"Topical", name:"GANA TC+", tag:"Post-Procedure Recovery",
    ...
    ings:["PDRN 2%","PHA 2%","Acetyl Hexapeptide-8"], vol:"45g tube", price:"90", img:null, badge:"4× Conc." },
  { id:"tc", cat:"Topical", name:"GANA TC", tag:"Daily Recovery Ointment",
    ...
    ings:["PDRN 0.5%","PHA (Lactobionic Acid)","Acetyl Hexapeptide-8"], vol:"45g tube", price:"45", img:null, badge:"Recovery" },
  { id:"ka", cat:"Topical", name:"GANA KA", tag:"Brightening Ointment",
    ...
    ings:["Kojic Acid 4%"], vol:"45g tube", price:"30", img:null, badge:"Brightening" },
  { id:"bb", cat:"Topical", name:"GANA BB", tag:"Treatment BB Cream (SPF 35)",
    ...
    ings:["PDRN","SPF 35"], vol:"45g tube", price:"30", img:null, badge:"Coverage" },
  { id:"gino-face", cat:"Chemical Peel", name:"GINO FACE", tag:"Natural Microneedling Peel",
    ...
    ings:["Sponge Spicules","Salicylic Acid","Alpha Arbutin"], vol:"45g tube", price:"90", img:null, badge:"Acne Specialist" },
  ...
  { id:"gino-body", cat:"Chemical Peel", name:"GINO BODY", tag:"Body Microneedling Peel",
    ...
    ings:["Sponge Spicules","Glycolic Acid","Urea"], vol:"45g tube", price:"90", img:null, badge:"Body Care" },
  { id:"pha", cat:"Chemical Peel", name:"GANA PHA", tag:"Gentle PHA Peel",
    ...
    ings:["Polyhydroxy Acid 10%","Alpha Arbutin 1%"], vol:"40ml", price:"60", img:null, badge:"Sensitive Skin" },
  { id:"gyno", cat:"Intimate Care", name:"GANA GYNO", tag:"Intimate Brightening & pH Care",
    ...
    ings:["Glutathione","Soy Isoflavone","Lactic Acid"], vol:"50ml", price:"60", img:null, badge:"Intimate Care" },
];
