...
const en: Dict = {
  ...
  prod: {
    ...
    "pep-apdn": { tag: "SYN-AKE Relaxing Peptide", desc: "Pure SYN-AKE dipeptide solution — relaxes expression wrinkles via acetylcholine antagonism (Botox-like).", usage: PEP_USE_EN, home: "SYN-AKE mimics the wrinkle-relaxing effect of snake venom, temporarily easing the micro-muscle contractions behind frown lines, forehead creases and crow's feet. Apply a few drops to cleansed skin morning and night, then moisturizer and daytime SPF.", clinic: "As peptides are large molecules, microneedling or dermarolling (0.2–0.5mm) channels SYN-AKE into the target tissue for maximum muscle-relaxing effect. Run as 2–3 sessions at 2-week intervals; cocktails well with other GANA peptides." },
    "pep-carnosine": { tag: "Anti-Aging Geroprotector", desc: "Pure L-Carnosine solution — a geroprotector that reduces telomere shortening for anti-aging.", usage: PEP_USE_EN, home: "L-Carnosine is a potent antioxidant and anti-glycation dipeptide — it shields collagen and elastin from sugar-induced stiffening and helps reduce telomere shortening, for daily anti-aging and firmness. Apply to face and neck after cleansing/toning, morning and night; layers under moisturizer.", clinic: "Its geroprotective action (anti-glycation, telomere protection) suits treatments that slow intrinsic aging. With microneedling/dermarolling (0.2–0.5mm) it penetrates deeper to protect collagen and elastin and drive cellular repair. 2–3 sessions at 2-week intervals." },
    "pep-ah8": { tag: "Argireline Wrinkle Peptide", desc: "Pure Acetyl hexapeptide-8 (Argireline) solution — Botox-like relaxation of expression wrinkles.", usage: PEP_USE_EN, home: "Acetyl Hexapeptide-8 (Argireline) gives a Botox-like effect by interrupting the nerve signals that contract facial muscles, visibly softening expression lines around the eyes and forehead — without injections. Apply to dynamic-wrinkle zones twice daily before heavier creams.", clinic: "Microneedling or dermarolling (0.2–0.5mm) opens micro-channels so Argireline reaches deeper to modulate muscle contraction, for a more pronounced, longer-lasting wrinkle reduction. Typically 2–3 sessions at 2-week intervals." },
    "pep-pp3": { tag: "Matrixyl Collagen Peptide", desc: "Pure Palmitoyl pentapeptide-3 (Matrixyl) solution — boosts collagen and elastin, reduces fine lines.", usage: PEP_USE_EN, home: "Palmitoyl Pentapeptide-3 (Matrixyl) is a signal peptide that tells skin cells to rebuild collagen and elastin, improving elasticity and reducing wrinkle depth for a smoother, firmer complexion. Apply to face and neck morning and night, massage in, then moisturize.", clinic: "Ideal for intensive collagen remodeling — delivered into the dermis via microneedling/dermarolling (0.2–0.5mm), it signals fibroblasts to produce new collagen and elastin for a marked firmness gain. 2–3 sessions at 2-week intervals." },
    "pep-pt1": { tag: "Skin-Repair Peptide", desc: "Pure Palmitoyl tripeptide-1 (pal-GHK) solution — repairs visible damage and strengthens skin's support structures.", usage: PEP_USE_EN, home: "Palmitoyl Tripeptide-1 (pal-GHK) is a repair peptide that strengthens the skin's support matrix, stimulating collagen and glycosaminoglycans to improve resilience and texture. Apply to cleansed skin on areas needing repair, morning and night before moisturizer.", clinic: "For advanced regeneration, microneedling/dermarolling (0.2–0.5mm) delivers pal-GHK to deeper layers to accelerate collagen synthesis, wound healing and firmness. 2–3 sessions at 2-week intervals; cocktails with other peptides." },
    "pep-mp17": { tag: "Eyelash Growth Peptide", desc: "Pure Myristoyl pentapeptide-17 solution — stimulates keratin genes to thicken and grow eyelashes.", usage: "Apply along lash line with an eye brush (avoid eyes), biweekly, 3–4 sessions.", home: "Myristoyl Pentapeptide-17 stimulates keratin genes to promote longer, thicker, fuller-looking lashes over time — a gentle alternative to extensions. Apply along the lash line with an eye brush like liquid eyeliner, biweekly, avoiding the eyes; use consistently for 3–4 sessions.", clinic: "A non-invasive lash-enhancement option clinics can guide and fold into beauty regimens. The key is precise, consistent lash-line application to stimulate keratin genes; works standalone or within a larger aesthetic plan." },
    "pep-agh1": { tag: "SNAP-8 Wrinkle Peptide", desc: "Pure Acetyl glutamyl heptapeptide-1 (SNAP-8) solution — an elongated Argireline for Botox-like wrinkle relaxation.", usage: PEP_USE_EN, home: "Acetyl Glutamyl Heptapeptide-1 (SNAP-8) is an elongated Argireline — it further reduces the muscle contractions behind expression wrinkles for a more potent Botox-like smoothing, especially on the forehead and around the eyes. Apply to pronounced lines twice daily before other serums.", clinic: "SNAP-8 offers superior dynamic-wrinkle reduction (studies suggest up to ~30% more potent than Argireline). Microneedling/dermarolling (0.2–0.5mm) achieves optimal penetration for deep, lasting muscle relaxation. 2–3 sessions at 2-week intervals." },
    "pep-at5": { tag: "Anti-Eyebag Peptide", desc: "Pure Acetyl tetrapeptide-5 solution — reduces puffy under-eye bags.", usage: PEP_USE_EN, home: "Acetyl Tetrapeptide-5 targets puffy under-eye bags by improving lymphatic circulation and reducing capillary permeability, easing fluid-retention puffiness and dark circles. Gently dab around the orbital bone after cleansing/toning, morning and night, before eye cream.", clinic: "For professional eye-bag treatment, microneedling/dermarolling (0.2–0.5mm) delivers Acetyl Tetrapeptide-5 to the periorbital area to cut fluid retention and boost microcirculation, for a rapid, visible reduction in eye bags. 2–3 sessions at 2-week intervals." },
    "pep-np1": { tag: "Whitening Peptide", desc: "Pure Nonapeptide-1 solution — inhibits tyrosinase activation for whitening and spot correction.", usage: PEP_USE_EN, home: "Nonapeptide-1 is a whitening peptide that inhibits tyrosinase — the key enzyme in melanin synthesis — fading existing dark spots, sun spots and post-inflammatory pigmentation while preventing new discoloration. Apply to cleansed skin on uneven areas morning and night, with daytime broad-spectrum SPF.", clinic: "For targeted hyperpigmentation, microneedling/dermarolling (0.2–0.5mm) enhances delivery of Nonapeptide-1 to melanocytes to inhibit tyrosinase, for a pronounced reduction in dark spots and a more even tone. 2–3 sessions at 2-week intervals." },
...
const zh: Dict = {
  ...
  prod: {
    ...
    "pep-apdn": { tag: "SYN-AKE 松弛肽", desc: "纯 SYN-AKE 二肽溶液 —— 通过拮抗乙酰胆碱舒缓表情纹（类肉毒）。", usage: PEP_USE_ZH, home: "SYN-AKE 模拟蛇毒的舒缓表情纹作用，暂时缓解额纹、皱眉纹与鱼尾纹背后的微肌肉收缩。洁面后早晚取数滴涂于表情纹处，随后使用保湿与日间防晒。", clinic: "肽分子较大，故以微针或滚轮（0.2–0.5mm）将 SYN-AKE 导入目标组织以获得最大舒缓效果。2–3 个疗程、间隔 2 周；可与其他 GANA 肽搭配。" },
    "pep-carnosine": { tag: "抗衰保护肽", desc: "纯 L-肌肽溶液 —— 减缓端粒缩短的抗衰保护剂。", usage: PEP_USE_ZH, home: "L-肌肽是强效抗氧化与抗糖化二肽，保护胶原与弹性蛋白免受糖化僵化，并有助减缓端粒缩短，用于日常抗衰与紧致。洁面爽肤后早晚涂于面颈，可叠加于其他精华之下。", clinic: "其抗衰保护作用（抗糖化、端粒保护）适合延缓内源性老化的疗程。配合微针/滚轮（0.2–0.5mm）可更深层渗透，保护胶原与弹性蛋白并促进细胞修复。2–3 个疗程、间隔 2 周。" },
    "pep-ah8": { tag: "Argireline 抗皱肽", desc: "纯 Acetyl hexapeptide-8（Argireline）溶液 —— 类肉毒舒缓表情纹。", usage: PEP_USE_ZH, home: "Acetyl Hexapeptide-8（Argireline）通过干扰促使面部肌肉收缩的神经信号产生类肉毒效果，无需注射即可柔化眼周与额头的表情纹。早晚涂于动态纹区域，于厚重面霜之前。", clinic: "微针或滚轮（0.2–0.5mm）开启微通道，使 Argireline 更深层调节肌肉收缩，带来更明显、更持久的抗皱效果。通常 2–3 个疗程、间隔 2 周。" },
    "pep-pp3": { tag: "Matrixyl 胶原肽", desc: "纯 Palmitoyl pentapeptide-3（Matrixyl）溶液 —— 促进胶原与弹性蛋白，减少细纹。", usage: PEP_USE_ZH, home: "Palmitoyl Pentapeptide-3（Matrixyl）是信号肽，指示皮肤细胞重建胶原与弹性蛋白，提升弹性、减少皱纹深度，使肤质更平滑紧致。早晚涂于面颈，按摩吸收后保湿。", clinic: "适合强效胶原重塑 —— 经微针/滚轮（0.2–0.5mm）导入真皮，刺激成纤维细胞生成新胶原与弹性蛋白，显著提升紧致度。2–3 个疗程、间隔 2 周。" },
    "pep-pt1": { tag: "皮肤修复肽", desc: "纯 Palmitoyl tripeptide-1（pal-GHK）溶液 —— 修复可见损伤，强化皮肤支撑结构。", usage: PEP_USE_ZH, home: "Palmitoyl Tripeptide-1（pal-GHK）是修复肽，强化皮肤支撑结构，刺激胶原与氨基葡聚糖以提升韧性与肤质。洁面后涂于需修复部位，早晚于保湿之前。", clinic: "用于深层再生，微针/滚轮（0.2–0.5mm）将 pal-GHK 导入深层，加速胶原合成、伤口愈合与紧致。2–3 个疗程、间隔 2 周；可与其他肽搭配。" },
    "pep-mp17": { tag: "睫毛增长肽", desc: "纯 Myristoyl pentapeptide-17 溶液 —— 刺激角蛋白基因，增浓并促进睫毛生长。", usage: "用眼刷沿睫毛根部涂抹（避开眼睛），每两周一次，3–4 个疗程。", home: "Myristoyl Pentapeptide-17 刺激角蛋白基因，随时间促进更长、更浓密、更丰盈的睫毛 —— 温和替代嫁接。用眼刷沿睫毛根部涂抹（如眼线），每两周一次，避开眼睛；坚持 3–4 个疗程。", clinic: "诊所可指导这一非侵入式睫毛增强方案并纳入美容护理。关键在于沿睫毛根部精准、持续地涂抹以有效刺激角蛋白基因；可单独使用或纳入整体美学方案。" },
    "pep-agh1": { tag: "SNAP-8 抗皱肽", desc: "纯 Acetyl glutamyl heptapeptide-1（SNAP-8）溶液 —— Argireline 的延长肽，类肉毒抗皱。", usage: PEP_USE_ZH, home: "Acetyl Glutamyl Heptapeptide-1（SNAP-8）是 Argireline 的延长版 —— 进一步减少表情纹背后的肌肉收缩，带来更强的类肉毒平滑效果，尤其在额头与眼周。早晚涂于明显纹路，于其他精华之前。", clinic: "SNAP-8 的动态抗皱效果优于 Argireline（研究表明强约 30%）。配合微针/滚轮（0.2–0.5mm）达到最佳渗透，实现深层持久的肌肉舒缓。2–3 个疗程、间隔 2 周。" },
    "pep-at5": { tag: "抗眼袋肽", desc: "纯 Acetyl tetrapeptide-5 溶液 —— 减轻眼下浮肿眼袋。", usage: PEP_USE_ZH, home: "Acetyl Tetrapeptide-5 针对眼下浮肿眼袋，改善淋巴循环、降低毛细血管通透性，缓解因水分滞留导致的浮肿与黑眼圈。洁面爽肤后早晚轻拍于眼眶骨周围，于眼霜之前。", clinic: "用于专业眼袋治疗，微针/滚轮（0.2–0.5mm）将 Acetyl Tetrapeptide-5 导入眼周，减少水分滞留并改善微循环，快速可见地减轻眼袋。2–3 个疗程、间隔 2 周。" },
    "pep-np1": { tag: "美白肽", desc: "纯 Nonapeptide-1 溶液 —— 抑制酪氨酸酶活化，美白并改善色斑。", usage: PEP_USE_ZH, home: "Nonapeptide-1 是美白肽，抑制黑色素合成关键酶酪氨酸酶，淡化已有色斑、晒斑与炎症后色沉，同时预防新色斑形成。洁面后早晚涂于不均区域，日间配合广谱防晒。", clinic: "针对色素沉着，微针/滚轮（0.2–0.5mm）增强 Nonapeptide-1 向黑色素细胞的导入以抑制酪氨酸酶，显著减少色斑、均匀肤色。2–3 个疗程、间隔 2 周。" },
...
const th: Dict = {
  ...
  prod: {
    ...
    "pep-apdn": { tag: "SYN-AKE เปปไทด์คลายกล้ามเนื้อ", desc: "ไดเปปไทด์ SYN-AKE บริสุทธิ์ — คลายริ้วรอยจากการแสดงสีหน้าผ่านการต้านอะเซทิลโคลีน (คล้ายโบทอกซ์)", usage: PEP_USE_TH, home: "SYN-AKE เลียนแบบฤทธิ์คลายริ้วรอยของพิษงู ช่วยคลายการหดตัวของกล้ามเนื้อเล็กๆ ที่ทำให้เกิดริ้วรอยขมวดคิ้ว หน้าผาก และหางตา ลงไม่กี่หยดบนผิวที่ทำความสะอาดแล้วเช้าและเย็นบริเวณริ้วรอย ตามด้วยมอยส์เจอไรเซอร์และกันแดด", clinic: "เนื่องจากเปปไทด์เป็นโมเลกุลขนาดใหญ่ จึงใช้ไมโครนีดเดิลหรือเดอร์มาโรลเลอร์ (0.2–0.5mm) เพื่อนำ SYN-AKE เข้าสู่เนื้อเยื่อเป้าหมายให้ได้ผลสูงสุด ทำ 2–3 ครั้ง เว้น 2 สัปดาห์ ผสมกับเปปไทด์ GANA อื่นได้" },
    "pep-carnosine": { tag: "สารชะลอวัย", desc: "L-Carnosine บริสุทธิ์ — สารชะลอวัยที่ลดการสั้นลงของเทโลเมียร์", usage: PEP_USE_TH, home: "L-Carnosine เป็นไดเปปไทด์ต้านอนุมูลอิสระและต้านไกลเคชันที่ทรงพลัง ปกป้องคอลลาเจนและอีลาสตินจากการแข็งตัวด้วยน้ำตาล และช่วยลดการสั้นลงของเทโลเมียร์ เพื่อชะลอวัยและความกระชับในแต่ละวัน ลงบนหน้าและคอหลังทำความสะอาดและโทนเนอร์ เช้าและเย็น", clinic: "ฤทธิ์ชะลอวัย (ต้านไกลเคชัน ปกป้องเทโลเมียร์) เหมาะกับทรีตเมนต์ที่ชะลอความแก่จากภายใน เมื่อใช้กับไมโครนีดเดิล/เดอร์มาโรลเลอร์ (0.2–0.5mm) จะซึมลึกขึ้นเพื่อปกป้องคอลลาเจนและอีลาสตินและกระตุ้นการซ่อมแซมเซลล์ 2–3 ครั้ง เว้น 2 สัปดาห์" },
    "pep-ah8": { tag: "Argireline เปปไทด์ลดริ้วรอย", desc: "Acetyl hexapeptide-8 (Argireline) บริสุทธิ์ — คลายริ้วรอยคล้ายโบทอกซ์", usage: PEP_USE_TH, home: "Acetyl Hexapeptide-8 (Argireline) ให้ผลคล้ายโบทอกซ์โดยรบกวนสัญญาณประสาทที่สั่งให้กล้ามเนื้อใบหน้าหดตัว ช่วยลดริ้วรอยรอบดวงตาและหน้าผากโดยไม่ต้องฉีด ลงบริเวณริ้วรอยไดนามิกวันละสองครั้งก่อนครีมเนื้อหนัก", clinic: "ไมโครนีดเดิลหรือเดอร์มาโรลเลอร์ (0.2–0.5mm) เปิดไมโครแชนเนลให้ Argireline เข้าลึกขึ้นเพื่อปรับการหดตัวของกล้ามเนื้อ ลดริ้วรอยได้ชัดเจนและยาวนานขึ้น โดยทั่วไป 2–3 ครั้ง เว้น 2 สัปดาห์" },
    "pep-pp3": { tag: "Matrixyl เปปไทด์คอลลาเจน", desc: "Palmitoyl pentapeptide-3 (Matrixyl) บริสุทธิ์ — เพิ่มคอลลาเจนและอีลาสติน ลดริ้วรอยเล็ก", usage: PEP_USE_TH, home: "Palmitoyl Pentapeptide-3 (Matrixyl) เป็นซิกแนลเปปไทด์ที่สื่อสารกับเซลล์ผิวให้สร้างคอลลาเจนและอีลาสตินใหม่ เพิ่มความยืดหยุ่นและลดความลึกของริ้วรอย เพื่อผิวเรียบเนียนกระชับ ลงบนหน้าและคอเช้าและเย็น นวดให้ซึมแล้วบำรุงด้วยมอยส์เจอไรเซอร์", clinic: "เหมาะกับการรีโมเดลคอลลาเจนเข้มข้น — นำส่งเข้าสู่ชั้นหนังแท้ด้วยไมโครนีดเดิล/เดอร์มาโรลเลอร์ (0.2–0.5mm) กระตุ้นไฟโบรบลาสต์ให้สร้างคอลลาเจนและอีลาสตินใหม่เพื่อความกระชับที่ชัดเจน 2–3 ครั้ง เว้น 2 สัปดาห์" },
    "pep-pt1": { tag: "เปปไทด์ซ่อมแซมผิว", desc: "Palmitoyl tripeptide-1 (pal-GHK) บริสุทธิ์ — ซ่อมแซมความเสียหายและเสริมโครงสร้างผิว", usage: PEP_USE_TH, home: "Palmitoyl Tripeptide-1 (pal-GHK) เป็นเปปไทด์ซ่อมแซมที่เสริมโครงสร้างค้ำจุนผิว กระตุ้นคอลลาเจนและไกลโคซามิโนไกลแคนเพื่อเพิ่มความยืดหยุ่นและเนื้อผิว ลงบนผิวที่ทำความสะอาดแล้วบริเวณที่ต้องการซ่อมแซม เช้าและเย็นก่อนมอยส์เจอไรเซอร์", clinic: "สำหรับการฟื้นฟูขั้นสูง ไมโครนีดเดิล/เดอร์มาโรลเลอร์ (0.2–0.5mm) นำส่ง pal-GHK สู่ชั้นลึกเพื่อเร่งการสร้างคอลลาเจน การสมานแผล และความกระชับ 2–3 ครั้ง เว้น 2 สัปดาห์ ผสมกับเปปไทด์อื่นได้" },
    "pep-mp17": { tag: "เปปไทด์ขนตายาว", desc: "Myristoyl pentapeptide-17 บริสุทธิ์ — กระตุ้นยีนเคราตินเพื่อขนตาดกและยาว", usage: "ลงตามแนวขนตาด้วยแปรงตา (เลี่ยงดวงตา) ทุก 2 สัปดาห์ 3–4 ครั้ง", home: "Myristoyl Pentapeptide-17 กระตุ้นยีนเคราตินเพื่อขนตาที่ยาว ดก และหนาขึ้นเมื่อเวลาผ่านไป — ทางเลือกอ่อนโยนแทนการต่อขนตา ลงตามแนวขนตาด้วยแปรงตาเหมือนอายไลเนอร์ ทุก 2 สัปดาห์ เลี่ยงดวงตา ใช้ต่อเนื่อง 3–4 ครั้ง", clinic: "ทางเลือกเสริมขนตาแบบไม่รุกล้ำที่คลินิกแนะนำและผสานเข้ากับการดูแลความงามได้ กุญแจคือการลงตามแนวขนตาอย่างแม่นยำและสม่ำเสมอเพื่อกระตุ้นยีนเคราติน ใช้เดี่ยวหรือเป็นส่วนหนึ่งของแผนความงามได้" },
    "pep-agh1": { tag: "SNAP-8 เปปไทด์ลดริ้วรอย", desc: "Acetyl glutamyl heptapeptide-1 (SNAP-8) บริสุทธิ์ — Argireline แบบยาว ลดริ้วรอยคล้ายโบทอกซ์", usage: PEP_USE_TH, home: "Acetyl Glutamyl Heptapeptide-1 (SNAP-8) คือ Argireline แบบยาว — ลดการหดตัวของกล้ามเนื้อที่ทำให้เกิดริ้วรอยมากขึ้น ให้ผลเรียบเนียนคล้ายโบทอกซ์ที่แรงกว่า โดยเฉพาะหน้าผากและรอบดวงตา ลงบริเวณริ้วรอยชัดวันละสองครั้งก่อนเซรั่มอื่น", clinic: "SNAP-8 ลดริ้วรอยไดนามิกได้เหนือกว่า Argireline (งานวิจัยชี้ว่าแรงกว่าราว 30%) เมื่อใช้กับไมโครนีดเดิล/เดอร์มาโรลเลอร์ (0.2–0.5mm) จะซึมได้ดีที่สุดเพื่อคลายกล้ามเนื้อลึกและยาวนาน 2–3 ครั้ง เว้น 2 สัปดาห์" },
    "pep-at5": { tag: "เปปไทด์ลดถุงใต้ตา", desc: "Acetyl tetrapeptide-5 บริสุทธิ์ — ลดถุงใต้ตาบวม", usage: PEP_USE_TH, home: "Acetyl Tetrapeptide-5 มุ่งเป้าถุงใต้ตาบวม โดยปรับการไหลเวียนน้ำเหลืองและลดการรั่วของหลอดเลือดฝอย ลดความบวมและรอยคล้ำจากการคั่งของน้ำ แตะเบาๆ รอบกระดูกเบ้าตาหลังทำความสะอาดและโทนเนอร์ เช้าและเย็น ก่อนครีมตา", clinic: "สำหรับการรักษาถุงใต้ตาระดับมืออาชีพ ไมโครนีดเดิล/เดอร์มาโรลเลอร์ (0.2–0.5mm) นำส่ง Acetyl Tetrapeptide-5 สู่รอบดวงตาเพื่อลดการคั่งของน้ำและเพิ่มการไหลเวียน ลดถุงใต้ตาได้เร็วและเห็นผล 2–3 ครั้ง เว้น 2 สัปดาห์" },
    "pep-np1": { tag: "เปปไทด์กระจ่างใส", desc: "Nonapeptide-1 บริสุทธิ์ — ยับยั้งการทำงานของไทโรซิเนสเพื่อความกระจ่างใสและลดจุดด่างดำ", usage: PEP_USE_TH, home: "Nonapeptide-1 เป็นเปปไทด์กระจ่างใสที่ยับยั้งไทโรซิเนส — เอนไซม์หลักในการสร้างเมลานิน ช่วยจางจุดด่างดำ จุดแดด และรอยดำหลังการอักเสบ พร้อมป้องกันการเกิดใหม่ ลงบนผิวที่ทำความสะอาดแล้วบริเวณสีไม่สม่ำเสมอ เช้าและเย็น พร้อมกันแดด", clinic: "สำหรับรอยดำเฉพาะจุด ไมโครนีดเดิล/เดอร์มาโรลเลอร์ (0.2–0.5mm) เพิ่มการนำส่ง Nonapeptide-1 สู่เมลาโนไซต์เพื่อยับยั้งไทโรซิเนส ลดจุดด่างดำชัดเจนและสีผิวสม่ำเสมอขึ้น 2–3 ครั้ง เว้น 2 สัปดาห์" },
...
const vi: Dict = {
  ...
  prod: {
    ...
    "pep-apdn": { tag: "Peptide giãn cơ SYN-AKE", desc: "Dung dịch dipeptide SYN-AKE nguyên chất — giãn nếp nhăn biểu cảm qua đối kháng acetylcholine (kiểu Botox).", usage: PEP_USE_VI, home: "SYN-AKE mô phỏng tác dụng giãn nếp nhăn của nọc rắn, tạm thời làm dịu các co thắt vi cơ gây nếp nhăn chau mày, trán và đuôi mắt. Thoa vài giọt lên da đã làm sạch sáng và tối tại vùng nếp nhăn, sau đó dưỡng ẩm và chống nắng.", clinic: "Vì peptide là phân tử lớn, dùng lăn kim hoặc dermaroller (0.2–0.5mm) để đưa SYN-AKE vào mô đích nhằm đạt hiệu quả giãn cơ tối đa. Thực hiện 2–3 buổi, cách 2 tuần; phối hợp tốt với các peptide GANA khác." },
    "pep-carnosine": { tag: "Chống lão hóa", desc: "Dung dịch L-Carnosine nguyên chất — chất chống lão hóa làm giảm rút ngắn telomere.", usage: PEP_USE_VI, home: "L-Carnosine là dipeptide chống oxy hóa và chống glycation mạnh — bảo vệ collagen và elastin khỏi xơ cứng do đường và giúp giảm rút ngắn telomere, cho chống lão hóa và săn chắc hằng ngày. Thoa lên mặt và cổ sau khi làm sạch và toner, sáng và tối.", clinic: "Tác dụng bảo vệ tế bào (chống glycation, bảo vệ telomere) phù hợp các liệu trình làm chậm lão hóa nội sinh. Khi dùng với lăn kim/dermaroller (0.2–0.5mm), thẩm thấu sâu hơn để bảo vệ collagen, elastin và thúc đẩy phục hồi tế bào. 2–3 buổi, cách 2 tuần." },
    "pep-ah8": { tag: "Peptide nếp nhăn Argireline", desc: "Dung dịch Acetyl hexapeptide-8 (Argireline) nguyên chất — giãn nếp nhăn biểu cảm kiểu Botox.", usage: PEP_USE_VI, home: "Acetyl Hexapeptide-8 (Argireline) cho hiệu ứng kiểu Botox bằng cách cản tín hiệu thần kinh khiến cơ mặt co lại, làm dịu rõ nếp nhăn quanh mắt và trán mà không cần tiêm. Thoa lên vùng nếp nhăn động hai lần mỗi ngày trước kem đặc.", clinic: "Lăn kim hoặc dermaroller (0.2–0.5mm) mở vi kênh để Argireline thấm sâu hơn điều hòa co cơ, cho hiệu quả giảm nhăn rõ và lâu hơn. Thường 2–3 buổi, cách 2 tuần." },
    "pep-pp3": { tag: "Peptide collagen Matrixyl", desc: "Dung dịch Palmitoyl pentapeptide-3 (Matrixyl) nguyên chất — tăng collagen và elastin, giảm nếp nhăn nhỏ.", usage: PEP_USE_VI, home: "Palmitoyl Pentapeptide-3 (Matrixyl) là peptide tín hiệu báo tế bào da tái tạo collagen và elastin, cải thiện độ đàn hồi và giảm độ sâu nếp nhăn cho làn da mịn và săn chắc hơn. Thoa lên mặt và cổ sáng và tối, massage cho thấm rồi dưỡng ẩm.", clinic: "Lý tưởng cho tái cấu trúc collagen chuyên sâu — đưa vào hạ bì qua lăn kim/dermaroller (0.2–0.5mm), kích thích nguyên bào sợi tạo collagen và elastin mới cho độ săn chắc rõ rệt. 2–3 buổi, cách 2 tuần." },
    "pep-pt1": { tag: "Peptide phục hồi da", desc: "Dung dịch Palmitoyl tripeptide-1 (pal-GHK) nguyên chất — sửa chữa hư tổn và củng cố cấu trúc nâng đỡ da.", usage: PEP_USE_VI, home: "Palmitoyl Tripeptide-1 (pal-GHK) là peptide phục hồi giúp củng cố cấu trúc nâng đỡ da, kích thích collagen và glycosaminoglycan để tăng độ bền và kết cấu da. Thoa lên da đã làm sạch tại vùng cần phục hồi, sáng và tối trước kem dưỡng ẩm.", clinic: "Cho tái tạo nâng cao, lăn kim/dermaroller (0.2–0.5mm) đưa pal-GHK vào lớp sâu để đẩy nhanh tổng hợp collagen, lành thương và săn chắc. 2–3 buổi, cách 2 tuần; phối với peptide khác." },
    "pep-mp17": { tag: "Peptide dài mi", desc: "Dung dịch Myristoyl pentapeptide-17 nguyên chất — kích thích gen keratin để mi dày và dài.", usage: "Thoa dọc chân mi bằng cọ mắt (tránh mắt), hai tuần một lần, 3–4 buổi.", home: "Myristoyl Pentapeptide-17 kích thích gen keratin để mi dài, dày và đầy đặn hơn theo thời gian — lựa chọn dịu nhẹ thay nối mi. Thoa dọc chân mi bằng cọ mắt như kẻ eyeliner, hai tuần một lần, tránh mắt; dùng đều đặn 3–4 buổi.", clinic: "Lựa chọn dưỡng mi không xâm lấn mà phòng khám có thể hướng dẫn và lồng vào quy trình làm đẹp. Mấu chốt là thoa chính xác, đều đặn dọc chân mi để kích thích gen keratin; dùng độc lập hoặc trong kế hoạch thẩm mỹ lớn hơn." },
    "pep-agh1": { tag: "Peptide nếp nhăn SNAP-8", desc: "Dung dịch Acetyl glutamyl heptapeptide-1 (SNAP-8) nguyên chất — Argireline kéo dài, giãn nếp nhăn kiểu Botox.", usage: PEP_USE_VI, home: "Acetyl Glutamyl Heptapeptide-1 (SNAP-8) là Argireline kéo dài — giảm thêm co cơ gây nếp nhăn biểu cảm cho hiệu quả làm mịn kiểu Botox mạnh hơn, đặc biệt ở trán và quanh mắt. Thoa lên nếp nhăn rõ hai lần mỗi ngày trước các serum khác.", clinic: "SNAP-8 giảm nhăn động vượt trội so với Argireline (nghiên cứu cho thấy mạnh hơn ~30%). Khi dùng lăn kim/dermaroller (0.2–0.5mm) đạt thẩm thấu tối ưu cho giãn cơ sâu và lâu dài. 2–3 buổi, cách 2 tuần." },
    "pep-at5": { tag: "Peptide chống bọng mắt", desc: "Dung dịch Acetyl tetrapeptide-5 nguyên chất — giảm bọng mắt dưới mắt.", usage: PEP_USE_VI, home: "Acetyl Tetrapeptide-5 nhắm vào bọng mắt bằng cách cải thiện tuần hoàn bạch huyết và giảm tính thấm mao mạch, làm dịu sưng và quầng thâm do ứ dịch. Nhẹ nhàng chấm quanh xương hốc mắt sau khi làm sạch và toner, sáng và tối, trước kem mắt.", clinic: "Cho điều trị bọng mắt chuyên nghiệp, lăn kim/dermaroller (0.2–0.5mm) đưa Acetyl Tetrapeptide-5 vào vùng quanh mắt để giảm ứ dịch và tăng vi tuần hoàn, giảm bọng mắt nhanh và rõ. 2–3 buổi, cách 2 tuần." },
    "pep-np1": { tag: "Peptide làm trắng", desc: "Dung dịch Nonapeptide-1 nguyên chất — ức chế kích hoạt tyrosinase để làm trắng và mờ đốm.", usage: PEP_USE_VI, home: "Nonapeptide-1 là peptide làm trắng ức chế tyrosinase — enzyme chính trong tổng hợp melanin — làm mờ đốm nâu, đốm nắng và tăng sắc tố sau viêm, đồng thời ngăn đốm mới. Thoa lên da đã làm sạch tại vùng không đều màu sáng và tối, kèm chống nắng phổ rộng ban ngày.", clinic: "Cho tăng sắc tố tại chỗ, lăn kim/dermaroller (0.2–0.5mm) tăng đưa Nonapeptide-1 đến melanocyte để ức chế tyrosinase, giảm đốm nâu rõ và đều màu hơn. 2–3 buổi, cách 2 tuần." },
