...
const en: Dict = {
  ...
  products: {
    label: "Cosmeceuticals", allLabel: "All", items: "{n} items", priceNote: "All pricing quoted on inquiry. Dealer & volume pricing available.",
  ...
  detail: {
    ...
    retailNote: "All pricing quoted on inquiry. Dealer & distributor terms available. Shipping not included.",
    inquireBtn: "Inquire about this product →", inquiryPrice: "Inquiry",
    keyActives: "Key Actives", specifications: "Specifications",
    specCategory: "Category", specVolume: "Volume / Packaging", specRetail: "Price", specLabel: "Label",
...
const zh: Dict = {
  ...
  products: {
    label: "药妆系列", allLabel: "全部", items: "{n} 件", priceNote: "所有价格均需询价。经销商与批量价格请另行咨询。",
  ...
  detail: {
    ...
    retailNote: "所有价格均需询价。经销商与代理条件请另行咨询。运费另计。",
    inquireBtn: "咨询此产品 →", inquiryPrice: "询价",
    keyActives: "核心活性成分", specifications: "规格参数",
    specCategory: "类别", specVolume: "容量 / 包装", specRetail: "价格", specLabel: "标签",
...
const th: Dict = {
  ...
  products: {
    label: "เวชสำอาง", allLabel: "ทั้งหมด", items: "{n} รายการ", priceNote: "ราคาทั้งหมดสอบถามได้ทางอีเมล ราคาตัวแทนจำหน่ายและราคาขายส่งมีให้บริการ",
  ...
  detail: {
    ...
    retailNote: "ราคาทั้งหมดสอบถามได้ทางอีเมล มีเงื่อนไขสำหรับตัวแทนจำหน่าย ไม่รวมค่าจัดส่ง",
    inquireBtn: "สอบถามผลิตภัณฑ์นี้ →", inquiryPrice: "สอบถามราคา",
    keyActives: "สารออกฤทธิ์หลัก", specifications: "ข้อมูลจำเพาะ",
    specCategory: "หมวดหมู่", specVolume: "ปริมาตร / บรรจุภัณฑ์", specRetail: "ราคา", specLabel: "ป้ายกำกับ",
...
const vi: Dict = {
  ...
  products: {
    label: "Dược mỹ phẩm", allLabel: "Tất cả", items: "{n} sản phẩm", priceNote: "Tất cả giá được báo khi có yêu cầu. Có giá đại lý & giá số lượng lớn.",
  ...
  detail: {
    ...
    retailNote: "Tất cả giá được báo khi có yêu cầu. Điều kiện đại lý & nhà phân phối vui lòng liên hệ. Chưa bao gồm phí vận chuyển.",
    inquireBtn: "Hỏi về sản phẩm này →", inquiryPrice: "Liên hệ giá",
    keyActives: "Hoạt chất chính", specifications: "Thông số kỹ thuật",
    specCategory: "Danh mục", specVolume: "Dung tích / Quy cách", specRetail: "Giá", specLabel: "Nhãn",
